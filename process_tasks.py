...
# -*- coding: utf-8 -*-
"""
PChome 數據分析任務處理器 - 完整版
讀取當前目錄下的 dsaa31_all_data.json 文件
完成所有4個任務:
- Task 1: 提取所有產品ID到 products.txt
- Task 2: 找出高評分產品ID到 best-products.txt  
- Task 3: 計算 ASUS i5 處理器 PC 平均價格
- Task 4: ASUS PC 價格 z-score 標準化分析
"""
...
def main():
    ...
    if zscore_result:
        print(f"   • Task 4: 已完成 {len([p for p in products if 'asus' in p.get('Brand', '').lower() or '華碩' in p.get('Brand', '')])} 個ASUS產品的 z-score 標準化")
